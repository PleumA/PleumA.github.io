...
const translations = {
    th: {
        ...
        ruleShiftBased: "โหมดจัดเวร 3 ผลัด / Shift-Based Mode",
        ruleShiftBasedDesc: "จัดตารางเวร 3 ผลัดต่อวัน (เช้า: 08:00-16:00, บ่าย: 16:00-24:00, ดึก: 24:00-08:00)",
        shiftMorning: "เวรเช้า (08:00 - 16:00)",
        shiftAfternoon: "เวรบ่าย (16:00 - 24:00)",
        shiftNight: "เวรดึก (24:00 - 08:00)",
        morningSlotsLabel: "จำนวนเวรเช้า",
        afternoonSlotsLabel: "จำนวนเวรบ่าย",
        nightSlotsLabel: "จำนวนเวรดึก",
        ...
        manualSection8Title: "8. โหมดจัดเวร 3 ผลัด (Shift-Based Mode)",
        manualSection8Body: "จัดตารางเวร 3 ผลัดต่อวัน (เช้า บ่าย ดึก) โดยสามารถระบุจำนวนคนในแต่ละผลัดได้อย่างอิสระ ระบบมีกฎห้ามอยู่เวรเช้าต่อจากเวรดึก (Night-to-Morning Spacing) และจะห้ามอยู่เวรดึกในวันก่อนวันหยุดของผู้ปฏิบัติงานนั้นๆ เท่านั้น (เวรเช้า/บ่ายของวันก่อนวันหยุดยังสามารถทำได้) พร้อมสถิติสรุปแบ่งตามแต่ละกะเวร",
    ...
    en: {
        ...
        ruleShiftBased: "Shift-Based Mode",
        ruleShiftBasedDesc: "Schedules Morning, Afternoon, and Night shifts with adjustable slot counts",
        shiftMorning: "Morning (8-16)",
        shiftAfternoon: "Afternoon (16-24)",
        shiftNight: "Night (24-8)",
        morningSlotsLabel: "Morning Slots",
        afternoonSlotsLabel: "Afternoon Slots",
        nightSlotsLabel: "Night Slots",
        ...
        manualSection8Title: "8. Shift-Based Mode (Morning, Afternoon, Night)",
        manualSection8Body: "Schedules 3 shifts per day (Morning, Afternoon, Night) with customizable slot counts. Enforces strict spacing: no Morning shifts following a Night shift, and blocks only the Night shift on the day before requested off. The stats table dynamically details Morning, Afternoon, and Night shifts worked by each doctor.",
